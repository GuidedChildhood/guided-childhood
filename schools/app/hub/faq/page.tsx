...
const FAQS = [
  ...
  { q: 'Who teaches the sensitive topics, and how are staff supported?', a: `Your own teachers, from fully scripted lessons in a deliberately calm register. ${FLAGGED_MODULES.length} modules are safeguarding flagged: each carries a DSL note with disclosure handling written into the scripts and a ten minute staff briefing in the Hub, and the Hub’s induction page runs the whole staff room through the scheme in fifteen minutes.` },
  ...
  { q: 'Does this replace our PSHE scheme?', a: 'No. It is the digital literacy and online safety spine, designed to slot inside your wider PSHE provision alongside whatever you use for the rest. The mapping matrix lists the digital and online requirements of the statutory guidance one by one, marks the ones this scheme teaches, and names the ones it deliberately leaves to your broader scheme.' },
  ...
  { q: 'Does subscribing make us compliant?', a: 'No product can make a school compliant, and we will not pretend otherwise. We provide the taught curriculum mapped requirement by requirement to the digital and online content of the statutory guidance, the documents that evidence it, and the scripts and briefings that support your staff. The matrix shows the requirements we do not teach alongside the ones we do. Your school remains responsible for its policies, its parent consultation and viewing route, its safeguarding systems, its filtering and monitoring, and its own judgement of provision. The policy pack in the Hub sets out both sides of that line in full.' },
]
