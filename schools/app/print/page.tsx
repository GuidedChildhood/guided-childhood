  ...
  return (
    <main style={{ minHeight: '100vh', background: 'var(--cream)', padding: PAGE_SHELL }}>
      <div style={{ maxWidth: '860px', margin: '0 auto' }}>
        ...
        <Link href="/print/passport" style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', textDecoration: 'none', color: 'var(--ink)', background: '#fff', border: '2px solid var(--terracotta)', borderRadius: '20px', padding: 'var(--space-4) var(--space-4)', marginBottom: '28px', boxShadow: '0 1px 2px rgba(23,60,70,0.04), 0 12px 32px -18px rgba(23,60,70,0.28)' }}>
        ...
        {byStage.map(({ ks, rows }) => {
          ...
          return (
            <section key={ks} style={{ marginBottom: '28px' }}>
              ...
              <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: '18px', padding: 'var(--space-3) var(--space-2) var(--space-2)', overflowX: 'auto', boxShadow: '0 1px 2px rgba(23,60,70,0.04), 0 12px 32px -18px rgba(23,60,70,0.28)' }}>
