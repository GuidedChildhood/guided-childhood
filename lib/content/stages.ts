...
export const STAGES: Stage[] = [
  {
    ...
    parentQuote: '"I did not realise how much the routine would help. The timer changed everything for us."',
    ...
    challengeActions: {
      ...
      mood_changes: 'Try ten minutes of wind down between screens and the next activity. At this age, mood is often about the transition, not the screen itself.',
  ...
  },
  {
    ...
    challengeActions: {
      screens_takeover: 'Agree on two zones in your home where screens never go: mealtimes and bedrooms. Agreed once, kept every day, no exceptions.',
  ...
  },
  {
    ...
    device: 'First personal device, a feature phone strongly recommended over a smartphone',
    isCritical: true,
    script: {
  ...
  },
  {
    ...
    challengeActions: {
      ...
      start_conversation: 'Ask about one thing they have been into online this week. Not a test, genuine curiosity. Then ask one more question.',
  ...
  },
  {
    ...
    challengeActions: {
      ...
      asking_for_phone: 'At this stage the conversation is about upgrading the relationship, not unlocking a device. What does responsible independence look like for someone nearly an adult?',
    },
  },
]
