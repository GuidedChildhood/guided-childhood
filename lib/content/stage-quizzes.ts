...
const BANKS: Record<number, StageQuiz> = {
  ...
  3: {
    ...
    pool: [
      { q: 'The Explorer stage is when the app starts on', options: ['Full social media accounts', 'The algorithm, the feed and telling what is real', 'Unsupervised gaming'], answer: 1, why: 'From around 11, abstract thinking can finally hold the algorithm and feed conversation, so that is when it lands. What AI is, and that it can be wrong, started back at Foundation.' },
      { q: 'Why does the algorithm conversation start now and not at 7', options: ['The apps require it', 'Abstract thinking can hold it around 11 to 13', 'Schools ask for it'], answer: 1, why: 'The research, Orben and Odgers, places the algorithm conversation in the 11 to 13 window, when a child can think abstractly enough to hold it. What AI is, and that it can be wrong, started back at Foundation.' },
