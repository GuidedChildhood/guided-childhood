...
export const HORIZONS: Horizon[] = [
  ...
  { band: '8-10', what: 'AI becomes a school skill, not just a homework shortcut. The US has made AI literacy national policy from primary age, with a national challenge where children from elementary school build with AI.', before: 'Treat it the way the US schools are being told to: a grown up leading it, honest about what it is, and the question "what could you make with it" beside "did you cheat with it". The hints not answers rule keeps the thinking in the child.', source: 'US Executive Order 14277 (April 2025); Presidential AI Challenge 2026; US Department of Education (July 2025)', country: 'US' },
