...
export const banContextForDigi: Record<SocialMediaLaw, string> = {
  ...
  full_ban_u16: `UK LEGISLATION IN FORCE: Full access ban for under-16s on social media is now live. Named platforms are banned for under-16s. Australian data (Bursztyn and colleagues, NBER 2026) shows only about a quarter of banned 14 and 15 year olds complied; most stayed on through workarounds. The bedroom conversation is now also a VPN conversation. Open communication work is more important than ever. Address both groups: children who comply (need the cliff edge plan for turning 16) and children who bypass (need safety in unregulated spaces and an open relationship with their parent). Never give or imply circumvention or workaround instructions. Pivot to the legal surface: messaging known friends, gaming, watching. The non-banned surface is where the pathway earns its place.`,
}
