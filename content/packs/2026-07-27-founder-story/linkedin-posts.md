# Founder Story — Building Guided Childhood. A five post LinkedIn series.

Justin's founder story, designed to ALTERNATE with the In Proportion self-diagnosis series (one In Proportion, then one founder post, and so on). Built from what the repo actually shows we are building, no invented personal biography. Warm, plain, direct, honest, building in the open. No em dashes. Each post under LinkedIn's 3000 character limit. Soft CTA on the final post only, routed to /starter-pack.

The best bits used: the calibrated pathway (never allow or deny), building DiGi a real cited brain (no invented stats, the scary viral research left out on purpose), the safety evals it failed and the fix in the open, deleting the fake homepage numbers, and the belief underneath (preparation over fear, connection is the protection, the real drivers are poverty and ACEs and parental mental health).

Note: everything here is grounded in the repo. Anything about Justin's personal life (whether he is a parent, his background, a founding moment) is deliberately left out, because the repo cannot know it. Add a personal line yourself wherever it would land.
...
**Image:** Justin in a square in Budapest, on a football tour, arms up, holding up a giant model of the moon. A real personal brand photo, not an illustration of the post.

**Suggested caption (nod to the image, not woven into the body):** Photo, me holding up the moon in Budapest last week. Felt about the size of the average parenting screens question.
...
## FOUNDER POST 2 — Building the brain
**Best posting slot:** after In Proportion Post 2.
...
## FOUNDER POST 3 — The night it failed its own safety test
**Best posting slot:** after In Proportion Post 3.
...
## FOUNDER POST 4 — I deleted my own social proof
**Best posting slot:** after In Proportion Post 4.
...
## FOUNDER POST 5 — Why I am building this [carries the soft CTA]
...
## The alternating calendar (with In Proportion)

In Proportion Post 1 is already posted. From here, alternate:

1. Founder Post 1 (the rule DiGi can never say yes or no)
2. In Proportion Post 2 (why they do it)
3. Founder Post 2 (building the brain)
4. In Proportion Post 3 (it fades when they feel heard)
5. Founder Post 3 (the safety test it failed)
6. In Proportion Post 4 (take it seriously, stay curious)
7. Founder Post 4 (deleting the fake numbers)
8. In Proportion Post 5 (the real risk, plus the CTA)
9. Founder Post 5 (why I am building this, plus the CTA)

Two series, one voice, landing on their two belief posts back to back at the end. Only two CTAs across the whole run, both near the close, both to /starter-pack.

## Compliance notes
- Grounded in the repo, no invented personal biography. Add your own personal line where it fits.
- Building in the open, honesty as the through line (the failed eval, the deleted numbers).
- The hidden thread (poverty, ACEs, parental mental health) stated plainly only in Founder Post 5, the one in ten landing.
- DiGi as the calibrated pathway, never allow or deny. Preparation over fear. Connection is the protection.
- No em dashes. Soft CTA on Founder Post 5 only.
