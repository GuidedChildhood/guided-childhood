...
const DIR = '/home/user/guided-childhood/content/printables/a-to-z-showdown';
...
await page.pdf({ path: DIR + '/product/a-to-z-showdown-A4.pdf', format: 'A4', printBackground: true });
await page.pdf({ path: DIR + '/product/a-to-z-showdown-USLetter.pdf', format: 'Letter', printBackground: true });
await page.evaluate(() => document.body.classList.add('ink'));
await page.waitForTimeout(400);
await page.pdf({ path: DIR + '/product/a-to-z-showdown-A4-ink-friendly.pdf', format: 'A4', printBackground: true });
...
for (const [id, name] of [['s1','wheel-screen'], ['s2','how-to-play']]) {
