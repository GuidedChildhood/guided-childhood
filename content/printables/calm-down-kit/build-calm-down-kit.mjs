...
const DIR = '/home/user/guided-childhood/content/printables/calm-down-kit';
...
await page.pdf({ path: DIR + '/product/calm-down-kit-A4.pdf', format: 'A4', printBackground: true });
await page.pdf({ path: DIR + '/product/calm-down-kit-USLetter.pdf', format: 'Letter', printBackground: true });
await page.evaluate(() => document.body.classList.add('ink'));
await page.pdf({ path: DIR + '/product/calm-down-kit-A4-ink-friendly.pdf', format: 'A4', printBackground: true });
...
for (const [id, name] of [['s1','star-breathing'], ['s2','feelings-check-in']]) {
