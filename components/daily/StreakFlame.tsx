...
export default function StreakFlame({ count, aliveToday }: StreakFlameProps) {
  ...
  return (
    ...
    >
      ...
      <div>
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-sm)', fontWeight: 700, color: aliveToday ? 'var(--terracotta-dark)' : 'var(--ink)', lineHeight: 1.1 }}>
          {count}
        </div>
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 600, color: 'var(--ink-muted)', letterSpacing: '0.05em', textTransform: 'uppercase', whiteSpace: 'nowrap', lineHeight: 1.3 }}>
