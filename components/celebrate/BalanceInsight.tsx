    ...
    <div style={{
      ...
      <div key={cur.id} style={{ animation: 'gcInsightIn 0.35s ease' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '11px', marginBottom: '12px' }}>
          ...
          <div>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink-soft)' }}>
        ...
        <p style={{ fontFamily: 'var(--font-body)', fontWeight: 500, fontSize: 'var(--text-md)', lineHeight: 1.55, color: 'var(--ink)', opacity: 0.86, margin: '0 0 14px' }}>
          {cur.body}
        </p>
      </div>
