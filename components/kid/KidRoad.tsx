  ...
  return (
    ...
    >
      <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 420, maxHeight: '86vh', overflowY: 'auto', background: 'var(--cream)', borderRadius: '24px', padding: '22px 20px', boxShadow: '0 20px 50px -16px rgba(26,26,46,0.4)' }}>
              ...
              <div key={stage.id} style={{ display: 'flex', gap: 14 }}>
                ...
                <div style={{ flex: 1, minWidth: 0, paddingBottom: last ? 0 : 16 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                    <span style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-lg)', color: here ? 'var(--ink)' : 'var(--ink-soft)', letterSpacing: '-0.01em' }}>
                      {stage.name}
                    </span>
                  ...
                  {here ? (
                    <div style={{ marginTop: 10, background: '#fff', border: '1.5px solid var(--border)', borderLeft: '6px solid var(--terracotta)', borderRadius: 16, padding: '14px 14px 12px' }}>
                      ...
                      <p style={{ fontSize: 'var(--text-md)', fontWeight: 600, color: 'var(--ink)', lineHeight: 1.5, margin: '0 0 10px' }}>
                      ...
                      {dailyGuideMinutes > 0 && (
                        <>
                          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--ink-muted)', marginBottom: 7 }}>
                        ...
                        <span style={{ flex: 1, textAlign: 'center', background: 'var(--tint-blue, #E4ECF7)', borderRadius: 12, padding: '9px 6px' }}>
                          {stageLessonsTotal != null && stageLessonsTotal > 0 ? (
                            <>
                              ...
                              <span style={{ display: 'block', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--ink-soft)', marginTop: 3 }}>stage lessons passed</span>
                            </>
                          ) : (
                            <>
                              <span style={{ display: 'block', fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-lg)', color: 'var(--ink)', lineHeight: 1 }}>{lessonsDoneCount}</span>
                              <span style={{ display: 'block', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--ink-soft)', marginTop: 3 }}>lessons done</span>
                            </>
                          )}
                        </span>
                    ...
                    <p style={{ fontSize: 'var(--text-base)', color: 'var(--ink-muted)', lineHeight: 1.45, margin: '7px 0 0' }}>
        ...
        <p style={{ fontSize: 'var(--text-base)', color: 'var(--ink-soft)', lineHeight: 1.5, margin: '16px 2px 14px', textAlign: 'center' }}>
