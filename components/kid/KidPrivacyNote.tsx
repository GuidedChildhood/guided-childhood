  ...
  return (
    <div style={{ margin: '18px 0 8px' }}>
      ...
      >
        ...
        <span aria-hidden style={{ fontSize: 'var(--text-base)', color: 'var(--ink-muted)', transform: open ? 'rotate(90deg)' : 'none', transition: 'transform 0.2s ease' }}>›</span>
      </button>
      ...
      {open && (
        <div style={{ background: '#fff', border: '1.5px solid var(--border)', borderRadius: 16, padding: '15px', marginTop: 8 }}>
          ...
          <ul style={{ margin: '0 0 12px', paddingLeft: 20 }}>
            <li style={{ fontSize: 'var(--text-md)', color: 'var(--ink)', lineHeight: 1.6, marginBottom: 5 }}>the jobs you tick off</li>
            <li style={{ fontSize: 'var(--text-md)', color: 'var(--ink)', lineHeight: 1.6, marginBottom: 5 }}>the stars you earn and spend</li>
            <li style={{ fontSize: 'var(--text-md)', color: 'var(--ink)', lineHeight: 1.6 }}>how long your screen time timer has been running</li>
          </ul>
          <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink)', lineHeight: 1.6, margin: '0 0 10px' }}>
            That is so they can say well done and send your stars. It is not there to catch you out.
          </p>
          <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink)', lineHeight: 1.6, margin: '0 0 10px', fontWeight: 700 }}>
