    ...
    <div style={{
      ...
      <div style={{ width: 'min(100%, 440px)' }}>
        <div style={{ textAlign: 'center', marginBottom: '18px' }}>
          ...
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: '13px', fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.72)', margin: '0 0 6px' }}>
            My screen deal
          </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '9px', marginBottom: '18px' }}>
          {promises.map((p, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px', background: '#fff', borderRadius: '16px', padding: '13px 15px' }}>
              ...
              <span style={{ fontSize: '16.5px', fontWeight: 600, color: 'var(--ink)', lineHeight: 1.45 }}>{p.text}</span>
            </div>
          ))}
        </div>
        ...
        <p style={{ textAlign: 'center', fontSize: '14.5px', color: 'rgba(255,255,255,0.66)', lineHeight: 1.5, margin: '12px 4px 0' }}>
