        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: 'var(--text-base)', color: 'var(--ink-muted)', textDecoration: 'underline', textUnderlineOffset: 3 }}
            >
              Not now
            </button>
          </div>
