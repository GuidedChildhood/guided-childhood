    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-lg)', color: 'var(--ink)', lineHeight: 1.2 }}>
            {a.headline}
          </div>
        </div>
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: 10, marginBottom: a.suggestSpread ? 12 : 0 }}>
          {jobsDueToday.slice(0, 8).map((j, i) => (
            <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 10, padding: '3px 0' }}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, color: 'var(--ink-muted)', flexShrink: 0 }}>~{jobMinutes(j)}m</span>
            </div>
          ))}
          {jobsDueToday.length > 8 && (
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', color: 'var(--ink-muted)', fontWeight: 700, marginTop: 3 }}>
