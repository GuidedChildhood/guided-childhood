...
export default function ScreenBalanceInsight({
  ...
  return (
    <div style={{
      background: '#fff', border: 'var(--edge)', borderLeft: `6px solid ${accent}`, boxShadow: 'var(--lift)',
      borderRadius: 'var(--radius-card)', padding: '18px 20px', marginBottom: '18px',
    }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
        ...
        <div style={{ minWidth: 0 }}>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: digiStepsIn ? accent : 'var(--terracotta-dark)', marginBottom: '3px' }}>
      ...
      {guide > 0 && (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', marginBottom: '12px' }}>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, color: overGuide ? accent : 'var(--ink-muted)', letterSpacing: '0.02em', textAlign: 'center' }}>
            Healthy screen guide for their age, about {guide} min{overGuide ? ' · over for today' : nearingGuide ? ' · nearly there' : ''}
          </span>
        </div>
      )}

      <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-base)', color: 'var(--ink-soft)', lineHeight: 1.55, margin: '0 0 8px' }}>
        {line}
      </p>
      {digiStepsIn && (
        <Link
      ...
      <div style={{ marginBottom: '12px' }}>
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.09em', textTransform: 'uppercase', color: 'var(--ink-muted)', marginBottom: '7px' }}>
        ...
        <div style={{ display: 'flex', gap: '7px', flexWrap: 'wrap' }}>
          {[
            ...
            <Link key={o.label} href={o.href} style={{
              ...
              background: 'var(--cream)', border: 'var(--edge)', borderRadius: '11px',
