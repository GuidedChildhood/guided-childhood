...
export default function QrHandoverModal({ token, childName, onClose }: {
  ...
  const secondary: React.CSSProperties = {
    ...
    fontWeight: 800, fontSize: 'var(--text-base)', color: 'var(--ink)',
  }
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--terracotta-dark)' }}>Scan to open</span>
        ...
        <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-xl)', letterSpacing: '-0.02em', color: 'var(--ink)', lineHeight: 1.1, margin: '0 0 16px' }}>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink-soft)', lineHeight: 1.55, margin: '0 0 18px', maxWidth: 280, marginLeft: 'auto', marginRight: 'auto' }}>
