    ...
    <div style={{ position: 'relative', maxWidth: '420px', margin: '0 auto' }}>
          ...
          return (
            <g key={i}>
              ...
              <text
                ...
                style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-md)' }}
              ...
              <text
                ...
                textAnchor={labelLeft ? 'end' : 'start'}
                style={{ fontFamily: 'var(--font-mono)', fontWeight: 600, fontSize: 'var(--text-xs)', letterSpacing: '0.06em' }}
                fill="var(--ink-muted)"
              >
                Ages {n.ages}
              </text>
      ...
      >
        <div style={{
          ...
          background: 'var(--terracotta)', color: 'var(--ink)', borderRadius: 'var(--radius-pill)',
