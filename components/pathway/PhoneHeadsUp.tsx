  ...
  return (
    <div style={{ background: 'var(--tint-sage)', border: '1.5px solid var(--tint-sage)', borderRadius: '20px', padding: '20px 22px', marginBottom: '20px' }}>
      ...
      <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
        <Link href="/dashboard/phone-setup" style={{ display: 'inline-flex', alignItems: 'center', gap: '7px', background: 'var(--terracotta)', color: 'var(--ink)', borderRadius: '13px', padding: '12px 18px', textDecoration: 'none', fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '15.5px', boxShadow: '0 4px 0 var(--terracotta-dark)' }}>
          How to set it up, our way
        </Link>
        <Link href="/dashboard/digi?q=When%20should%20my%20child%20get%20their%20first%20phone%2C%20and%20how%20do%20I%20set%20it%20up%3F" style={{ display: 'inline-flex', alignItems: 'center', color: 'var(--ink)', background: '#fff', border: '1.5px solid var(--border)', borderRadius: '13px', padding: '12px 18px', textDecoration: 'none', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '15px' }}>
          Ask DiGi
        </Link>
      </div>
    </div>
