...
export default function RoadToSixteen({
  ...
  return (
    ...
    >
      ...
      <p style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-lg)', color: 'var(--ink)', letterSpacing: '-0.01em', lineHeight: 1.25, margin: '0 0 3px' }}>
        {atEnd
          ? `${kid} is digitally ready`
          : `${kid} is on track, ${STAGE_LABELS[current - 1]} stage`}
      </p>
      <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-base)', color: 'var(--ink-soft)', lineHeight: 1.55, margin: '0 0 16px' }}>
