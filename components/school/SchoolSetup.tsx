  ...
  return (
    <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
      <div style={{
        ...
        fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, marginTop: '1px',
      }}>{n}</div>
      <div style={{ fontSize: 'var(--text-md)', color: 'var(--ink)', lineHeight: 1.6, flex: 1, minWidth: 0 }}>{children}</div>
    </div>
  )
}
...
export default function SchoolSetup() {
  ...
  if (screen === 'loading') {
    return <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink-muted)' }}>One moment...</p>
  }
  ...
  if (screen === 'pitch') {
    return (
      <div>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink-soft)', lineHeight: 1.65, marginBottom: '18px' }}>
  ...
  if (screen === 'form') {
    return (
      <div>
        ...
        <div style={card}>
          <label style={{ display: 'block', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--ink-muted)', marginBottom: '8px' }}>
            School or club name
          </label>
          <input
            value={schoolName}
          ...
          <input
            ...
            maxLength={200}
          />
          <p style={{ fontSize: 'var(--text-base)', color: 'var(--ink-muted)', lineHeight: 1.5, marginTop: '10px', marginBottom: 0 }}>
            Open a recent school email and copy the address it came from. Only emails from senders you list ever reach us.
          </p>
        </div>

        {errorMsg && (
          <p style={{ fontSize: 'var(--text-base)', color: 'var(--danger)', marginBottom: '14px' }}>{errorMsg}</p>
        )}
  ...
  if (screen === 'steps' && connection) {
    ...
    return (
      <div>
        ...
        <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink-soft)', lineHeight: 1.6, marginBottom: '18px' }}>
        ...
        <div style={{ ...card, display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
          <div style={{ flex: 1, minWidth: '180px' }}>
            <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-md)', color: 'var(--ink)', marginBottom: '2px' }}>
              Is the letterbox working?
            </div>
            <div style={{ fontSize: 'var(--text-base)', color: 'var(--ink-soft)', lineHeight: 1.5 }}>
        ...
        <div style={card}>
          ...
          <p style={{ fontSize: 'var(--text-base)', color: 'var(--ink-soft)', lineHeight: 1.6, marginTop: '14px', marginBottom: 0 }}>
        ...
        {!showAuto ? (
          ...
          >
            <span>
              <span style={{ display: 'block', fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-md)', color: 'var(--ink)', marginBottom: '4px' }}>
                Want it fully automatic?
              </span>
              <span style={{ display: 'block', fontSize: 'var(--text-base)', color: 'var(--ink-soft)', lineHeight: 1.5 }}>
            ...
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-sm)', color: 'var(--terracotta-dark)', flexShrink: 0 }}>→</span>
          </button>
        ) : (
          <>
                ...
                <div style={{
                  ...
                  {connection.verification_code ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                      <div>
                        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink-muted)', marginBottom: '4px' }}>Your confirmation code</div>
                        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-sm)', fontWeight: 700, color: 'var(--ink)', letterSpacing: '0.06em' }}>{connection.verification_code}</div>
                      </div>
                      <CopyButton value={connection.verification_code} label="Copy code" />
                    </div>
                  ) : connection.verification_link ? (
                    <div>
                      <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink-muted)', marginBottom: '6px' }}>Confirmation received</div>
                      <a href={connection.verification_link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 'var(--text-md)', color: 'var(--terracotta-dark)', fontWeight: 700 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <span style={{ fontSize: 'var(--text-base)', color: 'var(--ink-muted)' }}>Waiting for Google. Your code or confirm link usually arrives within a minute of clicking Add in Gmail.</span>
                    </div>
                  )}
                  {connection.verification_code && connection.verification_link && (
                    <div style={{ marginTop: '10px' }}>
                      <a href={connection.verification_link} target="_blank" rel="noopener noreferrer" style={{ fontSize: 'var(--text-base)', color: 'var(--terracotta-dark)', fontWeight: 700 }}>
      ...
      <div>
        ...
        <div style={card}>
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '12px', marginBottom: '14px' }}>
            <div>
              <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-lg)', color: 'var(--ink)', marginBottom: '4px' }}>
          ...
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink-muted)', marginBottom: '6px' }}>
          ...
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--ink-muted)', marginBottom: '8px' }}>
            Senders you allow
          </div>
          ...
          <div style={{ display: 'flex', gap: '8px', marginBottom: '4px' }}>
            <input
              ...
              type="email"
              style={{ ...inputStyle, padding: '10px 14px', fontSize: 'var(--text-base)', flex: 1 }}
              maxLength={200}
            />
            <button
              onClick={addSender}
          ...
          {errorMsg && <p style={{ fontSize: 'var(--text-base)', color: 'var(--danger)', marginTop: '8px', marginBottom: 0 }}>{errorMsg}</p>}
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap' }}>
          ...
          {confirmDelete ? (
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '10px' }}>
              <span style={{ fontSize: 'var(--text-base)', color: 'var(--ink-muted)' }}>Sure? This forgets the address and all reminders stop.</span>
  ...
  return (
    <div>
      <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink-muted)', marginBottom: '14px' }}>No connection yet.</p>
