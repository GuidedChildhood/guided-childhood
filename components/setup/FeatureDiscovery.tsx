  ...
  return (
    <div style={{
      ...
      <button
        onClick={dismiss}
        aria-label="Dismiss"
        style={{ position: 'absolute', top: 12, right: 12, background: 'none', border: 'none', color: 'rgba(255,255,255,0.6)', fontSize: 'var(--text-lg)', cursor: 'pointer', lineHeight: 1, padding: 4 }}
      >
        ×
      </button>
      ...
      <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-lg)', lineHeight: 1.2, marginBottom: '6px', paddingRight: '20px' }}>
        {tip.q}
      </div>
      <p style={{ fontSize: 'var(--text-base)', color: 'rgba(255,255,255,0.82)', lineHeight: 1.55, margin: '0 0 14px' }}>
        {tip.body}
      </p>
      ...
      <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
        ...
        <button
          onClick={dismiss}
          style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, cursor: 'pointer', letterSpacing: '0.04em' }}
        >
          Not now
        </button>
      </div>
