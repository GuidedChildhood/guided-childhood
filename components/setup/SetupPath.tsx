    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: '10px', marginBottom: '12px' }}>
        ...
        <span style={{ display: 'inline-flex', gap: '4px', alignItems: 'center' }}>
          ...
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, color: 'var(--ink-muted)', marginLeft: '4px' }}>
      ...
      <Link href={current.href} style={{ textDecoration: 'none' }}>
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-lg)', color: 'var(--ink)', lineHeight: 1.25, marginBottom: '4px' }}>
              {current.title}
            </div>
      ...
      {waiting.length > 0 && (
        <p style={{ margin: '14px 0 0', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', color: 'var(--ink-muted)', letterSpacing: '0.02em' }}>
