...
export default function LearningSheet({
  ...
  if (done) {
    ...
    return (
      <div style={{ background: 'var(--tint-sage)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '20px 22px' }}>
        ...
        {flaggedNames.length === 0 ? (
          ...
          <>
            ...
            <div style={{ borderTop: 'var(--edge)', marginTop: 16, paddingTop: 14 }}>
              {quest ? (
                <div style={{ background: '#fff', border: 'var(--edge)', borderRadius: 'var(--radius-tile)', padding: '13px 15px' }}>
                ...
                <>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: 'var(--lift)', opacity: questState === 'busy' ? 0.7 : 1,
                    }}
                  >
  ...
  return (
    <div>
      <div style={{ background: '#fff', border: 'var(--edge)', borderRadius: 'var(--radius-card)', overflow: 'hidden', boxShadow: 'var(--lift)' }}>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: 'var(--edge)',
                      borderRadius: 'var(--radius-tile)', padding: '12px 13px', marginBottom: 8, cursor: 'pointer',
                    }}
                  >
      ...
      <button
        ...
        style={{
          ...
          background: 'var(--terracotta)', color: 'var(--ink)', border: 'var(--edge)', borderRadius: 'var(--radius-btn)',
          fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-lg)',
          boxShadow: 'var(--lift)', opacity: saving ? 0.7 : 1,
        }}
      >
