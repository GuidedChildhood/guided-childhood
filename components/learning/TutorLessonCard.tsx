...
export default function TutorLessonCard({
  ...
  if (lesson && slides) {
    return (
      <div style={{ background: '#fff', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '16px 18px' }}>
        ...
        <div style={{ background: 'var(--cream)', border: 'var(--edge)', borderRadius: 'var(--radius-card)', padding: '14px 12px' }}>
          <LessonPlayer
            lessonId={lesson.id}
            lessonSource="lesson"
            slides={slides}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginTop: 14 }}>
          <button
            ...
            style={{
              ...
              color: 'var(--ink)', borderRadius: 'var(--radius-btn)', border: 'var(--edge)', boxShadow: 'var(--lift)',
          ...
          <button
            ...
            style={{
              ...
              color: 'var(--ink)', borderRadius: 'var(--radius-btn)', border: 'var(--edge)',
              fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-md)',
              boxShadow: 'var(--lift)', opacity: busy ? 0.6 : 1,
            }}
          >
            Send it to {name}
          </button>
  ...
  return (
    <div style={{ background: 'var(--tint-blue)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '18px 20px' }}>
      ...
      <button
        ...
        style={{
          ...
          background: 'var(--deep-teal)', color: '#fff', border: 'var(--edge)', borderRadius: 'var(--radius-btn)',
