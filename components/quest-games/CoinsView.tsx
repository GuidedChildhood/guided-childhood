    ...
    <>
      ...
      {serving ? (
        ...
        <div ref={stageRef}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
            <div ref={pebbleRef} style={{ flexShrink: 0 }}>
              ...
              <img src={PEBBLE_IMG} alt="Pebble" width={72} height={72}
                style={{ width: 72, height: 72, borderRadius: '50%', objectFit: 'cover', border: '3px solid #fff', boxShadow: 'var(--lift)' }} />
            </div>
            <div style={{
              flex: 1, background: '#fff', border: 'var(--edge)',
              borderRadius: 'var(--radius-card)', padding: '12px 15px', boxShadow: 'var(--lift)',
            }}>
          ...
          <div style={{
            background: 'var(--stage-1, #FFFBEE)', border: 'var(--edge)',
            borderRadius: 'var(--radius-btn)', padding: '12px 14px', marginBottom: '12px',
          }}>
