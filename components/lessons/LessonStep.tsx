    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span aria-hidden style={{ width: 32, height: 32, borderRadius: 9, background: '#fff', border: 'var(--edge)', boxSizing: 'border-box', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><HappyIcon name={step.icon} size={22} /></span>
      ...
      {/* Main content card */}
      <div style={{ background: '#fff', border: 'var(--edge)', borderRadius: 'var(--radius-btn)', overflow: 'hidden', borderTop: `4px solid ${color}`, boxShadow: 'var(--lift)' }}>
        ...
        {/* Character says */}
        {characterSays && (
          <div style={{ borderTop: 'var(--edge)', padding: '18px 28px', background: colorLight, display: 'flex', gap: '14px', alignItems: 'flex-start' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: color, border: 'var(--edge)', boxSizing: 'border-box', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 'var(--text-lg)', flexShrink: 0 }}>
              {emoji}
            </div>
            <div>
        ...
        {/* Fun fact */}
        {funFact && (
          <div style={{ borderTop: 'var(--edge)', padding: '16px 28px', background: 'var(--cream)', display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
            <span aria-hidden style={{ width: 32, height: 32, borderRadius: 9, background: '#fff', border: 'var(--edge)', boxSizing: 'border-box', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}><HappyIcon name="lessons" size={22} /></span>
