  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: '560px', width: '100%', textAlign: 'center' }}>
        ...
        {/* Name tag */}
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: 'rgba(255,255,255,.5)', marginBottom: '4px' }}>{c.kit}</div>
        ...
        <button
          ...
          style={{ fontSize: 'var(--text-md)', padding: '16px 40px', width: '100%', maxWidth: '320px', cursor: 'pointer' }}
        >
