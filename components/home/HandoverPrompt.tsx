...
export default function HandoverPrompt({
  ...
  const reason = (emoji: string, title: string, body: string) => (
    <li style={{ display: 'flex', gap: 10, alignItems: 'flex-start', marginBottom: 9 }}>
      <span aria-hidden style={{ flexShrink: 0, fontSize: 17, lineHeight: 1.3 }}>{emoji}</span>
      <span>
        <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 14.5, color: 'var(--ink)' }}>{title}</span>
        <span style={{ display: 'block', fontSize: 13.5, color: 'var(--ink-soft)', lineHeight: 1.45, marginTop: 1 }}>{body}</span>
      </span>
    </li>
  )
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 11, padding: '16px 18px 14px', background: 'var(--terracotta-lt)' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, fontWeight: 700, letterSpacing: '0.13em', textTransform: 'uppercase', color: 'var(--terracotta-dark)' }}>
        ...
        <div style={{ padding: '16px 18px 4px' }}>
          <p style={{ fontSize: 15, color: 'var(--ink)', fontWeight: 600, lineHeight: 1.5, margin: '0 0 13px' }}>
        ...
        {failed && (
          <p style={{ margin: '10px 18px 0', fontSize: 13, color: 'var(--terracotta-dark)', fontWeight: 700 }}>
        ...
        <div style={{ padding: '14px 18px 18px' }}>
          <button
            ...
            style={{
              ...
              borderRadius: 16, fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 16,
          ...
          <p style={{ fontSize: 12, color: 'var(--ink-muted)', lineHeight: 1.45, margin: '8px 0 0', textAlign: 'center' }}>
