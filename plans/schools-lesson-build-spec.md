...
- **CASEL, the five SEL competencies (Self awareness, Self management, Social awareness, Relationship skills, Responsible decision making).** The dominant social and emotional learning frame, used by SEL led and international schools and the frame Common Sense maps to. **So what:** map every module to a primary CASEL competency alongside EfCW and RSHE, which widens the buyer beyond the UK statutory frame. The young scaffold (Notice, Choose, Tell) reads straight onto CASEL: Notice is self and social awareness, Choose is self management and responsible decision making, Tell is relationship skills. Full module by module mapping and the proposed nullable `casel_competency` column are in the deep dive, `plans/2026-08-20-schools-foundation-build-brief.md` part 1.
