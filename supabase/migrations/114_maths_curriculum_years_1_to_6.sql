...
insert into public.curriculum_objectives (year_group, subject, term, strand, objective, source, verbatim, checkpoint, sort_order) values
  ...
  (3, 'maths', 'summer', 'Measurement', 'estimate and read time with increasing accuracy to the nearest minute' || chr(59) || ' record and compare time in terms of seconds, minutes and hours' || chr(59) || ' use vocabulary such as o''clock, am/pm, morning, afternoon, noon and midnight', 'National curriculum in England: mathematics programmes of study, updated 28 September 2021, year 3', true, null, 50),
  ...
  (3, 'maths', 'summer', 'Statistics', 'solve one-step and two-step questions [for example ''How many more?'' and ''How many fewer?''] using information presented in scaled bar charts and pictograms and tables', 'National curriculum in England: mathematics programmes of study, updated 28 September 2021, year 3', true, null, 130)
on conflict (curriculum, year_group, subject, term, objective) do nothing;
...
insert into public.curriculum_objectives (year_group, subject, term, strand, objective, source, verbatim, checkpoint, sort_order) values
  ...
  (5, 'maths', 'spring', 'Fractions (including decimals and percentages)', 'recognise the per cent symbol (%) and understand that per cent relates to ''number of parts per 100'', and write percentages as a fraction with denominator 100, and as a decimal fraction', 'National curriculum in England: mathematics programmes of study, updated 28 September 2021, year 5', true, null, 220),
