...
-- A real 16:9 poster image per watch together lesson, a frame lifted from
-- the finished video, used by the parent thumbnail shelf and the player.
-- Posters live on the CDN. Idempotent: the column add is guarded, the
-- updates set each poster by lesson code. Flat statements, no DO blocks.
