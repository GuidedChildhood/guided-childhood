-- 032: Lesson v3 refit for the reference lesson (ks3-12-misinfo-deepfakes).
-- Adds the 60 minute arc to every slide (phase + minutes, drawn as the
-- phase strip in the player), one honest sourced stat slide, and two timed
-- talk tasks (discussion slides with the countdown run by the player).
-- Supersedes 031's deck. Dashboard safe: one dollar quoted UPDATE.
