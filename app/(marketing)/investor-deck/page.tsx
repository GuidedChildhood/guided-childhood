...
export default function InvestorDeckPage() {
  return (
    <div style={WRAP}>
      <p style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--terracotta)', marginBottom: '10px' }}>Investor deck</p>
      ...
      <p style={{ fontSize: 'var(--text-md)', lineHeight: 1.65, color: 'var(--ink-soft)', margin: '0 auto 26px', maxWidth: 520 }}>
      ...
      <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
        <a href="mailto:hello@guidedchildhood.com?subject=Investor%20deck%20request" className="btn btn-gold" style={{ padding: '13px 26px', fontSize: 'var(--text-base)' }}>Request the deck</a>
        <Link href="/investor" className="btn" style={{ padding: '13px 26px', fontSize: 'var(--text-base)', border: '1.5px solid var(--border)' }}>Back to the overview</Link>
      </div>
    </div>
  )
}
