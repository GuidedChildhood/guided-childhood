    ...
    <div style={{ background: 'var(--cream)' }}>
        ...
        <div className="container">
          <div className="two-col" style={{ gap: '64px' }}>
            <div>
              ...
              <Link href="https://www.guidedchildhood.com/schools" className="btn btn-ink" style={{ fontSize: '.78rem', padding: '12px 24px' }}>
                Schools resources
              </Link>
            </div>
      ...
      <footer style={{ padding: '32px 24px', borderTop: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
          {[['Home', '/'], ['For schools', 'https://www.guidedchildhood.com/schools'], ['Join', '/join'], ['Digital wellbeing', 'https://www.guidedchildhood.com/digitalwellbeing']].map(([label, href]) => (
            <Link
              key={label} href={href}
