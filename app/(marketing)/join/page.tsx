...
const STAGE_COLORS = {
  1: { bg: 'var(--green-lt)', text: 'var(--green-dark)', border: '#D3ECD9', accent: '#AFDCA2' },
  2: { bg: 'var(--lav)', text: 'var(--lav-deep)', border: '#b8c8f0', accent: '#3D5BA9' },
  3: { bg: 'var(--coral-lt)', text: 'var(--coral)', border: 'rgba(212,96,10,.25)', accent: '#D4600A' },
  4: { bg: 'var(--gold-lt)', text: 'var(--gold-dark)', border: 'rgba(242,201,76,.4)', accent: '#C9962A' },
  5: { bg: '#FDFBF8', text: 'var(--ink-soft)', border: 'var(--border)', accent: '#AFDCA2' },
} as const
  ...
  return (
    <div style={{ background: 'var(--cream)', overflowX: 'hidden' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '1080px', margin: '0 auto', display: 'flex', alignItems: 'center', height: '64px', justifyContent: 'space-between' }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
            <div style={{ width: '32px', height: '32px', background: 'var(--green-dark)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 3px 0 rgba(0,0,0,.2)' }}>
      ...
      <section style={{ padding: 'clamp(64px, 10vw, 104px) 32px', background: 'var(--cream)', position: 'relative', overflow: 'hidden' }}>
        {/* Background */}
        <div aria-hidden="true" style={{ position: 'absolute', top: '-100px', right: '-100px', width: '440px', height: '440px', borderRadius: '50%', background: 'var(--green)', opacity: .06, pointerEvents: 'none' }} />

        <div style={{ maxWidth: '860px', margin: '0 auto', textAlign: 'center' }}>
          {/* Urgency badge */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'var(--coral-lt)', border: '1.5px solid rgba(212,96,10,.3)', borderRadius: '100px', padding: '7px 16px', marginBottom: '24px' }}>
            <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--coral)', display: 'inline-block' }} />
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: '.68rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--coral)' }}>
          ...
          <h1 style={{
            ...
            <em style={{ fontStyle: 'italic', fontWeight: 300, color: 'var(--coral)' }}>ready for everything.</em>
          </h1>
      ...
      {/* Guarantee strip */}
      <div style={{ background: 'var(--green-lt)', borderTop: '1px solid #D3ECD9', borderBottom: '1px solid #D3ECD9', padding: '14px 32px', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '28px', flexWrap: 'wrap' }}>
        {['30 day money back guarantee', 'Cancel any time', 'No lock-in'].map((item, i) => (
          <span key={i} style={{ display: 'flex', alignItems: 'center', gap: '7px', fontFamily: 'var(--font-mono)', fontSize: '.68rem', fontWeight: 600, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--green-dark)' }}>
            <span style={{ width: '16px', height: '16px', borderRadius: '50%', background: 'var(--green-dark)', color: '#fff', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: '.6rem', flexShrink: 0 }}>✓</span>
            {item}
          </span>
        ))}
      </div>
      ...
      <section className="section-lg" style={{ background: '#FDFBF8' }}>
        <div style={{ maxWidth: '1080px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '44px' }}>
            <p className="eyebrow" style={{ color: 'var(--coral)', marginBottom: '12px' }}>Five stages</p>
      ...
      <section className="section-lg">
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <p className="eyebrow" style={{ color: 'var(--green-dark)', marginBottom: '12px' }}>The method</p>
            <h2 style={{ marginBottom: '14px' }}>
              One framework.{' '}
              <em style={{ fontStyle: 'italic', fontWeight: 300, color: 'var(--coral)' }}>All the way through.</em>
            </h2>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 0 }}>
            {[
              { letter: 'T', word: 'Timing', desc: 'Right conversation, right moment. Not too early, not too late.', bg: 'var(--green-lt)', color: 'var(--green-dark)' },
              { letter: 'R', word: 'Relationships', desc: 'Connection before compliance. The relationship is the protection.', bg: 'var(--coral-lt)', color: 'var(--coral)' },
              { letter: 'U', word: 'Upstream', desc: 'Environment before rules. Platform mechanics matter more than willpower.', bg: 'var(--gold-lt)', color: 'var(--gold-dark)' },
              { letter: 'S', word: 'Sleep', desc: 'Bedroom rule. The single highest-impact change in the system.', bg: '#EFE9DF', color: 'var(--ink-soft)' },
              { letter: 'T', word: 'Transparency', desc: 'Openness over secrecy. Co-navigation over monitoring.', bg: 'var(--lav)', color: 'var(--lav-deep)' },
            ].map((item, i) => (
              <div key={i} style={{
                flex: 1,
                minWidth: '140px',
      ...
      {/* ================================================================
          JUSTIN STORY
          ================================================================ */}
      <section className="section-lg" style={{ background: 'var(--green-dark)' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', marginBottom: '28px', flexWrap: 'wrap' }}>
            ...
            <div>
              <p className="eyebrow" style={{ color: 'rgba(175,220,162,.8)', marginBottom: '8px' }}>Why I built this</p>
      ...
      <section className="section-lg" style={{ background: '#FDFBF8' }}>
        <div style={{ maxWidth: '920px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <p className="eyebrow" style={{ color: 'var(--green-dark)', marginBottom: '12px' }}>The research bench</p>
            <h2 style={{ marginBottom: '14px' }}>
              Built on evidence,{' '}
          ...
          <div className="four-col">
            {[
              { name: 'Prof. Candace Odgers', institution: 'UC Irvine · Duke', note: 'Effects depend on vulnerability and environment, not hours of use.', initial: 'CO', bg: 'var(--green-lt)', color: 'var(--green-dark)' },
              { name: 'Dr Amy Orben', institution: 'Cambridge MRC · Oxford', note: 'The 11 to 13 developmental window. Peak sensitivity for girls.', initial: 'AO', bg: 'var(--coral-lt)', color: 'var(--coral)' },
              { name: 'Prof. Andrew Przybylski', institution: 'Oxford OII', note: 'The Goldilocks effect. Moderate, structured use is not the problem.', initial: 'AP', bg: 'var(--gold-lt)', color: 'var(--gold-dark)' },
              { name: 'Prof. Sonia Livingstone', institution: 'LSE, London', note: 'Children need skills and agency, not just restrictions.', initial: 'SL', bg: 'var(--lav)', color: 'var(--lav-deep)' },
            ].map((expert, i) => (
      ...
      <section className="section-lg">
        <div style={{ maxWidth: '1040px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '44px' }}>
            <p className="eyebrow" style={{ color: 'var(--green-dark)', marginBottom: '12px' }}>What is inside</p>
            <h2 style={{ marginBottom: '14px' }}>
              Everything you need.{' '}
              <em style={{ fontStyle: 'italic', fontWeight: 300, color: 'var(--coral)' }}>At the right moment.</em>
            </h2>
          </div>
          ...
          <div className="three-col">
            {FEATURES.map((f, i) => (
              <div key={i} style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: '18px', padding: '28px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ fontSize: '1.6rem', color: 'var(--green-dark)', lineHeight: 1 }}>{f.icon}</div>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '44px' }}>
            ...
            <h2>
              ...
              <em style={{ fontStyle: 'italic', fontWeight: 300, color: 'var(--coral)' }}>where you are</em>
            </h2>
          </div>
              ...
              <div key={i} style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: '18px', padding: '28px', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', paddingTop: '14px', borderTop: '1px solid var(--border)' }}>
                  ...
                  <div>
                    ...
                    <span style={{ background: 'var(--green-lt)', color: 'var(--green-dark)', borderRadius: '100px', padding: '2px 8px', fontSize: '.62rem', fontWeight: 700, fontFamily: 'var(--font-mono)' }}>
                      {t.stage}
                    </span>
                  </div>
                </div>
      ...
      {/* ================================================================
          NOT TOO LATE
          ================================================================ */}
      <section style={{ padding: 'clamp(48px, 6vw, 72px) 32px', background: 'var(--gold-lt)', borderTop: '1px solid rgba(242,201,76,.4)', borderBottom: '1px solid rgba(242,201,76,.4)' }}>
      ...
      <section className="section-lg">
        <div style={{ maxWidth: '840px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '44px' }}>
            <p className="eyebrow" style={{ color: 'var(--green-dark)', marginBottom: '12px' }}>Membership</p>
          ...
          <div className="two-col-issues" style={{ gap: '16px' }}>
            ...
            {/* Annual */}
            <div style={{ background: 'var(--green-lt)', border: '2px solid var(--green-dark)', borderRadius: '20px', padding: '28px', position: 'relative' }}>
              <div style={{ position: 'absolute', top: '-13px', left: '50%', transform: 'translateX(-50%)', background: 'var(--green-dark)', color: '#fff', fontFamily: 'var(--font-mono)', fontSize: '.68rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', padding: '6px 16px', borderRadius: '100px', whiteSpace: 'nowrap' }}>
                Save £57
              </div>
              <p className="eyebrow" style={{ marginBottom: '12px', marginTop: '8px', color: 'var(--green-dark)' }}>Annual</p>
              ...
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '.72rem', color: 'var(--green-dark)', fontWeight: 700, marginBottom: '20px' }}>
      ...
      <section className="section-lg" style={{ background: '#FDFBF8' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '36px' }}>
            <p className="eyebrow" style={{ color: 'var(--green-dark)', marginBottom: '12px' }}>Questions</p>
      ...
      {/* ================================================================
          FINAL CTA
          ================================================================ */}
      <section style={{ padding: 'clamp(72px, 10vw, 112px) 32px', textAlign: 'center', background: 'var(--green-dark)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '540px', margin: '0 auto', position: 'relative' }}>
          <p className="eyebrow" style={{ color: 'rgba(175,220,162,.8)', marginBottom: '18px' }}>Your starting point is three questions away</p>
