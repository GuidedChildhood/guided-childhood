...
export default function HomePage() {
  return (
    <div style={{ background: '#fff', overflowX: 'hidden' }}>
      ...
      {/* ================================================================
          THE ROAD FROM 4 TO 16 — the pathway as the centrepiece, in the
          exact same road grammar the parent then meets inside the app:
          butter circles, dotted trail, a passport stamp on every stage.
          ================================================================ */}
      <section id="stages" style={{ padding: 'clamp(80px, 10vw, 120px) 32px', background: '#FFFBEE', scrollMarginTop: '70px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <p className="eyebrow fu" style={{ textAlign: 'center', color: 'var(--terracotta-dark)', marginBottom: '14px' }}>The pathway</p>
          <h2 className="fu" style={{ textAlign: 'center', fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(2rem, 4vw, 3rem)', letterSpacing: '-0.03em', lineHeight: 1.06, color: 'var(--ink)', margin: '0 0 16px' }}>
            One road, from 4 to 16.
          </h2>
          <p className="fu" style={{ textAlign: 'center', fontSize: '18px', color: 'var(--ink-soft)', lineHeight: 1.65, maxWidth: '620px', margin: '0 auto 56px' }}>
          ...
          <div className="fu road-scroll">
            <div className="road-row">
              {([
                ...
                <div key={s.n} style={{ flex: 1, minWidth: '170px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                  <span style={{
                  ...
                  <p style={{ fontSize: '13.5px', color: 'var(--ink-soft)', lineHeight: 1.55, margin: '10px 0 0', maxWidth: 180 }}>{s.line}</p>
                </div>
              ))}
            </div>
          </div>

          <p className="fu" style={{ textAlign: 'center', fontSize: '.82rem', color: 'var(--ink-muted)', marginTop: '36px' }}>
      ...
      {/* ================================================================
          EVERY MOMENT — the battles named, with the real illustrated tiles
          ================================================================ */}
      <section style={{ background: 'var(--deep-teal)', padding: 'clamp(72px, 9vw, 104px) 32px' }}>
        <div style={{ maxWidth: '1040px', margin: '0 auto' }}>
          <p className="eyebrow fu" style={{ textAlign: 'center', color: 'var(--terracotta)', marginBottom: '14px' }}>Every moment, covered</p>
          <h2 className="fu" style={{ textAlign: 'center', fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(1.8rem, 3.6vw, 2.6rem)', letterSpacing: '-0.03em', lineHeight: 1.08, color: '#fff', margin: '0 0 16px' }}>
            The battles you are actually in,<br />with the words that work.
          </h2>
          <p className="fu" style={{ textAlign: 'center', fontSize: '17px', color: 'rgba(255,255,255,0.82)', lineHeight: 1.65, maxWidth: '560px', margin: '0 auto 48px' }}>
          ...
          <div className="fu" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '16px' }}>
            {([
              ...
              <div key={t.label} style={{ background: '#fff', borderRadius: '18px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.22)' }}>
                <div aria-hidden style={{ width: '100%', aspectRatio: '1', background: `var(--terracotta-lt) center/cover no-repeat url(https://d8j0ntlcm91z4.cloudfront.net/user_3DfAawD3Umi5iqU3oLyR59j3JKD/${t.img})` }} />
                <div style={{ padding: '10px 12px', fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '12.5px', color: 'var(--ink)', lineHeight: 1.3 }}>
                  {t.label}
                </div>
              </div>
            ))}
      ...
      {/* ================================================================
          FOR YOU, NOT JUST THEM — the parent held too
          ================================================================ */}
      <section style={{ padding: 'clamp(72px, 9vw, 104px) 32px', background: '#FFFBEE' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center' }}>
          <p className="eyebrow fu" style={{ color: 'var(--terracotta-dark)', marginBottom: '14px' }}>For you, not just them</p>
          <h2 className="fu" style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(1.9rem, 3.8vw, 2.7rem)', letterSpacing: '-0.03em', lineHeight: 1.12, color: 'var(--ink)', margin: '0 0 18px' }}>
            You are not doing this wrong,<br />and you are not doing it alone.
          </h2>
          <p className="fu" style={{ fontSize: '18px', color: 'var(--ink-soft)', lineHeight: 1.7, maxWidth: '560px', margin: '0 auto 28px' }}>
          ...
          <Link href="/starter-pack" className="btn btn-gold fu" style={{ fontSize: '16px', padding: '16px 34px' }}>
            Start the pathway free
          </Link>
          <p className="fu" style={{ fontFamily: 'var(--font-mono)', fontSize: '11.5px', fontWeight: 600, color: 'var(--ink-muted)', marginTop: '14px' }}>
