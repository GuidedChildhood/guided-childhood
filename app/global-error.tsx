    ...
    <html lang="en">
      <body style={{ margin: 0, background: '#F7F3EE', color: '#26263A', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        <div style={{
          ...
          <h1 style={{ fontWeight: 800, fontSize: 'var(--text-xl)', margin: '0 0 10px' }}>
            Something went wrong
          </h1>
          <p style={{ fontSize: 'var(--text-md)', color: '#55516A', lineHeight: 1.6, maxWidth: 360, margin: '0 0 24px' }}>
          ...
          {error.digest && (
            <p style={{ fontFamily: 'ui-monospace, monospace', fontSize: 'var(--text-sm)', color: '#8A8598', marginTop: 20 }}>
