  ...
  return (
    <div>
      <div style={{
        ...
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--green-dark)' }}>
          Lesson checklist
        </span>
        <span style={{
                ...
                <div key={item.key} style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: '#fff', fontWeight: 900, fontSize: 'var(--text-md)', cursor: 'pointer',
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    {item.detail && (
                      <div style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-base)', color: 'var(--ink-muted)', lineHeight: 1.5, marginTop: '2px' }}>
                        {item.detail}
                      </div>
                    )}
                  </div>
                  {item.href && (
                    <Link href={item.href} target={item.external ? '_blank' : undefined} style={{
                      flexShrink: 0, fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-base)',
