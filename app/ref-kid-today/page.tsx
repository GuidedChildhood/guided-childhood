...
export default async function RefKidToday({ searchParams }: { searchParams: Promise<{ view?: string; holiday?: string }> }) {
  ...
  return (
    <KidQuestScreen
      ...
      streakDays={3}
      bank={{ child_id: 'fixture-child', earned: 30, spent: 12, balance: 8, minutes: 40, lifetimeBalance: 18, lifetimeMinutes: 90, weekEarned: 12, weekSpent: 4, weekSurplus: 0, weekCap: 105, starMinutes: 5 }}
