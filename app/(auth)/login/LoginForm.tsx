      ...
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div className="card" style={{ borderRadius: '20px', boxShadow: '0 5px 0 var(--border)' }}>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {error && (
              <div style={{ padding: '12px 16px', background: 'var(--stage-1)', borderRadius: '10px', color: 'var(--ink)', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-sm)' }}>
                {error}
              </div>
            )}
          ...
          <div style={{ marginTop: '20px', textAlign: 'center' }}>
            <Link href="/forgot-password" style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-sm)', color: 'var(--ink-muted)', textDecoration: 'none' }}>
