...
const BUSY = { ticksToConfirm: 4, printablesToConfirm: 2, schoolOpen: 1, agreementSigned: false, starsToSpend: 40, starChartPrinted: false, timeAsks: 1, timersRunning: 0 }
...
const RUNNING = { ticksToConfirm: 0, printablesToConfirm: 0, schoolOpen: 0, agreementSigned: true, starsToSpend: 0, starChartPrinted: true, timeAsks: 0, timersRunning: 1 }
const QUIET = { ticksToConfirm: 0, printablesToConfirm: 0, schoolOpen: 0, agreementSigned: true, starsToSpend: 0, starChartPrinted: true, timeAsks: 0, timersRunning: 0 }
