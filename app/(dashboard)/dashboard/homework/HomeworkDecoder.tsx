    ...
    <div>
      ...
      {child && !child.hasBirthday ? (
        <div style={{ background: '#fff', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '18px 20px' }}>
          ...
          <Link href="/dashboard/settings" style={{ display: 'inline-flex', padding: '11px 17px', textDecoration: 'none', background: 'var(--terracotta)', color: 'var(--ink)', borderRadius: 'var(--radius-tile)', fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-md)', boxShadow: '0 3px 0 var(--terracotta-dark)' }}>
            Add the birthday
          </Link>
        </div>
      ) : (
        <>
          ...
          {result && !result.ok && (
            <div style={{ background: '#fff', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '18px 20px', marginTop: 14 }}>
              <div style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-lg)', color: 'var(--ink)', lineHeight: 1.2, marginBottom: 6 }}>
          ...
          {result && result.ok && (
            <div style={{ marginTop: 14, display: 'flex', flexDirection: 'column', gap: 12 }}>
              <div style={{ background: 'var(--tint-sage)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '18px 20px' }}>
              ...
              {result.help && (
                <div style={{ background: 'var(--terracotta-lt)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '18px 20px' }}>
              ...
              <Link
                ...
                style={{
                  ...
                  background: '#fff', color: 'var(--ink)', borderRadius: 'var(--radius-btn)', border: 'var(--edge)', boxShadow: 'var(--lift)',
