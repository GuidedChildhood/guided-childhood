...
const SUGGESTED_PROMPTS = [
  ...
  'Her mood drops after phone use — what do I say?',
  'My son will not stop gaming. Is this a problem?',
  'How do I talk about the algorithm with my child?',
]
...
export default function DigiPage() {
  ...
  const atLimit = dailyCount >= FREE_LIMIT
