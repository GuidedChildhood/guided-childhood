...
export default async function OrdersPage() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 20px 60px' }}>
      <Link href="/dashboard" style={{ fontFamily: 'var(--font-mono)', fontSize: 12, fontWeight: 700, color: 'var(--ink-muted)', textDecoration: 'none' }}>
        ‹ Home
      </Link>
      ...
      <p style={{ fontSize: 15, color: 'var(--ink-soft)', lineHeight: 1.6, marginBottom: 24, maxWidth: 540 }}>
...
function Empty({ note }: { note: string }) {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 20px 60px' }}>
      ...
      <p style={{ fontSize: 15, color: 'var(--ink-soft)', lineHeight: 1.6 }}>{note}</p>
    </div>
  )
}
