...
const field: React.CSSProperties = { width: '100%', padding: '11px 13px', borderRadius: 'var(--radius-tile)', border: 'var(--edge)', background: '#fff', fontFamily: 'var(--font-body)', fontSize: 'var(--text-md)', color: 'var(--ink)', outline: 'none', boxSizing: 'border-box', marginBottom: 16 }
...
export default function NewScriptForm({ prefillSituation }: { prefillSituation?: string }) {
  ...
  return (
    <div>
      ...
      <div style={{ borderTop: 'var(--edge)', margin: '4px 0 16px', paddingTop: 16 }}>
