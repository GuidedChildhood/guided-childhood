  ...
  return (
    <div style={{ maxWidth: '680px', margin: '0 auto', padding: '24px 20px 48px' }}>
      ...
      <Link
        ...
        style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: 'var(--text-sm)', color: 'var(--ink-muted)', textDecoration: 'none', marginBottom: '24px', fontFamily: 'var(--font-mono)', letterSpacing: '0.04em' }}
      >
        ← All topics
      </Link>
      ...
      <div style={{
        ...
        <div style={{ padding: '16px 22px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
          <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink-muted)', margin: 0 }}>{meta.description}</p>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', color: meta.accent, letterSpacing: '0.06em' }}>
