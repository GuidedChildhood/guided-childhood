...
export default function WeekPage() {
  ...
  return (
    <div style={{ maxWidth: '640px', margin: '0 auto', padding: '20px 20px 40px' }}>
      <Link href="/dashboard" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, letterSpacing: '0.04em', color: 'var(--ink-muted)', textDecoration: 'none', marginBottom: '18px' }}>
        ← Home
      </Link>
