  ...
  return (
    <div style={{ maxWidth: '640px', margin: '0 auto', padding: '32px 20px' }}>
      ...
      {/* WHAT THE MONEY IS ACTUALLY FOR, above the price rather than below it.
          Justin, 8 August 2026: "should we have here the big quest idea of
          rewarding offline chores and play with stars to use their device,
          creating healthy balance and habits as they navigate the pathway to
          social media at 16, trusted, safe and confident."

          Yes, and the page was weaker for missing it. Everything else here is
          a parts list: five stages, unlimited DiGi, 100 scripts, a tracker, a
          builder. All true, none of it says what happens to your child. The
          stars loop is the most distinctive thing the product does and the
          only bit a parent cannot get anywhere else, and it was not mentioned
          on the one page where somebody decides to pay.

          Deliberately before the pricing card, because a number means nothing
          until you know what it buys. */}
      <div style={{
