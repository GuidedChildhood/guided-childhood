...
export default async function ContractPage() {
  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '24px 20px 40px' }}>
      ...
      <p className="no-print" style={{ fontSize: 'var(--text-base)', color: 'var(--ink-soft)', lineHeight: 1.6, margin: '-8px 0 20px', maxWidth: '540px' }}>
        ...
        return (
          <div key={child.id} className="contract-sheet" style={{
            ...
            <div style={{ textAlign: 'center', margin: '4px 0 18px' }}>
              <div style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'var(--text-2xl)', color: 'var(--ink)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>
                {child.name}&apos;s Device Time Contract
              </div>
              <div style={{ ...mono, fontSize: 'var(--text-sm)', color: 'var(--ink-muted)', marginTop: '6px' }}>
                Agreed on {today}
              </div>
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 'var(--text-base)', fontWeight: 700, color: 'var(--ink)', lineHeight: 1.5, margin: 0 }}>
            ...
            {first.length > 0 && (
              <div style={{ border: '2px dashed var(--terracotta-dark)', borderRadius: '14px', padding: '13px 16px', marginBottom: '16px' }}>
                ...
                <p style={{ fontSize: 'var(--text-sm)', color: 'var(--ink-soft)', margin: '8px 0 0', lineHeight: 1.5 }}>
            ...
            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--ink-soft)', lineHeight: 1.55, margin: '0 0 18px' }}>
