...
export default async function WatchTogetherLessonPage({ params }: { params: Promise<{ code: string }> }) {
  ...
  return (
    <div style={{ maxWidth: '640px', margin: '0 auto', padding: '24px 20px' }}>
      <Link href="/dashboard/lessons/together" style={{ fontFamily: 'var(--font-mono)', fontSize: '13px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--ink-muted)', textDecoration: 'none', display: 'inline-block', marginBottom: '16px' }}>
        ← All lessons
      </Link>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <p style={{ fontSize: '15.5px', color: 'var(--ink-soft)', fontStyle: 'italic' }}>
      ...
      <div style={{ background: 'var(--terracotta-lt)', border: '1.5px solid var(--terracotta)', borderRadius: '16px', padding: '14px 18px', marginBottom: '20px' }}>
        ...
        {lesson.parent_note && (
          <p style={{ fontSize: '15px', color: 'var(--ink-soft)', lineHeight: 1.6, margin: '8px 0 0' }}>
            {lesson.parent_note}
          </p>
        )}
      </div>
