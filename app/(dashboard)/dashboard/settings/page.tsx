...
export default function SettingsPage() {
  ...
  return (
    <div style={{ maxWidth: '540px', margin: '0 auto', padding: '24px 20px 40px' }}>
      ...
      {error && (
        <div style={{ background: 'var(--stage-1)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: '10px', padding: '12px 16px', marginBottom: '20px', fontSize: 'var(--text-md)', color: 'var(--ink)' }}>
          {error}
        </div>
      )}
      ...
      {kids.map(kid => {
        ...
        return (
        <section key={kid.id} style={{ background: 'var(--cream)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-btn)', padding: '22px', marginBottom: '16px' }}>
      ...
      {inTrialNow && (
        <section style={{ background: 'var(--stage-1)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-btn)', padding: '22px', marginBottom: '16px' }}>
        ...
        {isPaid ? (
          <>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', fontWeight: 700, background: 'var(--stage-2)', color: 'var(--terracotta)', padding: '3px 10px', borderRadius: 'var(--radius-pill)' }}>
                {tierLabel} member
              </span>
              {profile?.is_founder && (
      ...
      {/* Sign out */}
      <section id="sign-out" style={{ scrollMarginTop: 84, background: 'var(--cream)', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-btn)', padding: '22px' }}>
