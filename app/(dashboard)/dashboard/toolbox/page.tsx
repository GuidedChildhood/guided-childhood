...
export default async function ToolboxPage() {
  ...
  return (
    <div style={{ maxWidth: '640px', margin: '0 auto', padding: '24px 20px 48px' }}>
      ...
      <p style={{ fontSize: 'var(--text-lg)', color: 'var(--ink-soft)', lineHeight: 1.6, margin: '0 0 22px', maxWidth: '560px' }}>
      ...
      {tools.length === 0 ? (
        <div style={{ background: '#fff', border: 'var(--edge)', boxShadow: 'var(--lift)', borderRadius: 'var(--radius-card)', padding: '22px', textAlign: 'center' }}>
          ...
          <Link href="/dashboard/digi" style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'var(--text-base)', color: 'var(--terracotta-dark)', textDecoration: 'none' }}>
            Ask DiGi →
          </Link>
        </div>
      ) : (
